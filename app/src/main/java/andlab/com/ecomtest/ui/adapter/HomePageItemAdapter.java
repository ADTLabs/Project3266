...
public class HomePageItemAdapter extends RecyclerView.Adapter<HomePageItemAdapter.MyViewHolder> {
    ...
    public HomePageItemAdapter(List<String> horizontalList,PostItemListener itemListener) {
